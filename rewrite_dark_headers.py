...
# Buscamos el inicio de {activeTab === 'sales' && (
start_idx = text.find("{activeTab === 'sales' && (")
# Buscamos el inicio de {activeTab === 'terminal' && (
...
if start_idx != -1 and end_idx != -1:
                                                ...
                                                salesByRep.map((rep, i) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="py-2 text-gray-500 font-semibold text-right">0.00</td>
                                                            <td className="py-2 text-gray-500 font-semibold text-right">${(parseMoney(rep.amount || rep.total_amount) * 0.6).toFixed(2)}</td>
                                                            <td className="py-2 pr-2 text-[#34C38F] text-right">40.00%</td>
                                                        </tr>
                                                    );
                                                })
                                            )}
    ...
    print("Error: No se encontró el bloque esperado.")
