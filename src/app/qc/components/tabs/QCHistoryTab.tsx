...
import { RefreshCw, Pencil, Trash2, History, Calendar, Download } from "lucide-react";
...
export default function QCHistoryTab({ onEditQC }: Props) {
    ...
    return (
        <div className="flex flex-col h-full gap-1.5">
            ...
            <div className="flex flex-col md:flex-row gap-1.5 flex-1 min-h-0">

                {/* Left: date panel (hidden on mobile) */}
                <div className="hidden md:flex w-52 flex-col bg-white rounded-md border border-[#DBD9D9] shadow-sm overflow-hidden shrink-0">
                    <div className="h-10 bg-white border-b border-[#DBD9D9] flex items-center gap-2 px-3 shrink-0">
                        ...
                        <span className="text-[#4F4F4F] text-[14px] font-bold uppercase tracking-tight truncate flex-1">QC Dates</span>
