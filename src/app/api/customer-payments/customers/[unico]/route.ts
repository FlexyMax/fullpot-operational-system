...
export async function PUT(req: NextRequest, { params }: P) {
    ...
    try {
        ...
        const r = await executeProcedure("sp_flower_customers_update_from_payments", {
            ...
            lcfax_1:                   b.fax_1                     ?? "",
            lcemail:                   b.email                     ?? "",
            // Use parseFloat/parseInt for ALL numeric params — ?? 0 fails on empty strings
            lncredit_limit:            parseFloat(b.credit_limit)      || 0,
            lnprice_margin:            parseFloat(b.price_margin)      || 0,
            llcredithold:              b.credithold                     ? 1 : 0,
            lcreasonhold:              b.reasonhold                    ?? "",
            llactive:                  b.active !== false               ? 1 : 0,
            llauto_charge:             b.auto_charge                    ? 1 : 0,
            lninsurance_for:           parseFloat(b.insurance_for)     || 0,
            lcstatement_by:            b.statement_by                  ?? "",
            lcap_email:                b.ap_email                      ?? "",
            lcap_fax:                  b.ap_fax                        ?? "",
            lnextension:               parseInt(b.extension)           || 0,
            lndiscount:                parseFloat(b.discount_percentage)|| 0,
