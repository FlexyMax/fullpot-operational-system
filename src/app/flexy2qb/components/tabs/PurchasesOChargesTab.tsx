        ...
        <div className="flex-1 p-2 bg-[#f4f6f8] flex flex-col">
          {subTab === "not-ready" && (
            <div className="flex flex-col h-full gap-2">
              <span className="text-[11px] font-black uppercase text-gray-500 tracking-widest">Data in Flexymax Not Ready To Transfer</span>
              <TabTable
                ...
                actions={(row) => (
                  <>
                    <button onClick={() => markReady.mutate({ lcCharge_uq: row.unico, llready: true })} title="Mark Ready" className="text-green-600 hover:bg-green-100 p-1 rounded"><CheckCircle size={14} /></button>
                  </>
                )}
              />
            </div>
          ...
          {subTab === "ready" && (
            <div className="flex flex-col h-full gap-2">
              ...
              <TabTable
                ...
                actions={(row) => (
                  <>
                    <button onClick={() => sendToQb.mutate({ lcCharge_uq: row.unico, llready: true })} title="Send to QB" className="text-blue-600 hover:bg-blue-100 p-1 rounded"><Send size={14} /></button>
                    <button onClick={() => markReady.mutate({ lcCharge_uq: row.unico, llready: false })} title="Unmark Ready" className="text-red-600 hover:bg-red-100 p-1 rounded"><XCircle size={14} /></button>
                  </>
                )}
              />
            </div>
