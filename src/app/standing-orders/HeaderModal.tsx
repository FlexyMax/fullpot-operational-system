...
import { X, Loader2, Check, ClipboardList } from "lucide-react";
...
export function HeaderModal({ mode, header, lookups, onClose, onSaved }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl flex flex-col overflow-hidden" style={{ maxHeight: "94dvh" }}>
